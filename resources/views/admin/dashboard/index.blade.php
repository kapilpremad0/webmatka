                            ...
                            <div class="card card-company-table">
                                <div class="card-header">
                                    ...
                                    <div class="col-md-3" style="text-align: end">
                                        <input type="text" id="userSearch4" class="form-control" placeholder="Search">
                                    </div>
                                </div>
                                                    ...
                                                    <td>
                                                        ...
                                                        @else
                                                            <ul>
                                                                ...
                                                                <li>Bank Account Number : {{ $item->bank_account_number }}
                                                                </li>
                                                        ...
                                                        @if ($item->status == 'Pending')
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-end">
                                                                    ...
                                                                    <a class="dropdown-item" href="#"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#accept_{{ $item->id }}">
                                                                    ...
                                                                    <a class="dropdown-item" href="#"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#reject_{{ $item->id }}">
                                                                        <i data-feather='x'></i>
                                                                        <span>Reject</span>
                                                                    </a>
                                                            ...
                                                            <div class="modal fade modal-danger text-start"
                                                                ...
                                                                <div class="modal-dialog modal-dialog-centered">
                                                                    ...
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <form
                                                                            action="{{ route('admin.change_withdrawl_request') }}"
                                                                            method="POST">
                                                                            @csrf
...
<script>
    ...
    @push('scripts')
        ...
        <script>
            $(document).ready(function() {
                $('#userSearch4').on('input', function() {
                    fetchUserData($(this).val());
                });
