                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="form" action="{{ route('admin.games.store') }}" method="POST" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="text" id="first-name-column" name="name" class="form-control" placeholder="Name"  value="{{ old('name') }}" />
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="text" id="first-name-column" name="hindi_name" class="form-control" placeholder="Hindi Name"  value="{{ old('hindi_name') }}" />
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="time" id="first-name-column" name="open_time" class="form-control" placeholder="Open Time"  value="{{ old('open_time') }}" />
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="time" id="first-name-column" name="close_time" class="form-control" placeholder="Close Time"  value="{{ old('close_time') }}" />
